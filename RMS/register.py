...
class Register:
    def __init__(self,root):
        ...
        btn_register=Button(frame1,text="REGISTER NOW--->",font=("italic",12,"bold"),bg="green",bd=1,cursor="hand2",command=self.register_data).place(x=50, y=420)
        btn_Login = Button(self.root, text="Sign In", font=("times new roman",20), bg="white", bd=1,cursor="hand2", command=self.login_window).place(x=200, y=460,width=180)
